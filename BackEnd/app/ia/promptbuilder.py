class PromptBuilder:
    ...
    def build_system_prompt(self):
        ...
        return (
            ...
            "- Dévoile les informations relatives à ton personnage si l'enquêteur pose une question dessus.\n	"
...
#            "- Réponds toujours en cinq phrases maximum. \n"
            ...
            "- Si la question de l’enquêteur correspond à une **condition** d’un indice, alors tu dois OBLIGATOIREMENT révéler LA TOTALITE de cet indice. \n"
            ...
            "- Si l'enquêteur pose une question par rapport à un attribut du personnage, tu dois TOUJOURS dire la vérité sur cet attribut.\n"
